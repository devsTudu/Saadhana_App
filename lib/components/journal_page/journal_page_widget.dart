              ...
              child: Column(
                ...
                children: [
                                    ...
                                    (e) => e
                                      ..updateJournal(
                                        (e) => e.add(JournalsStruct(
                                          ...
                                          contentJournal: _model
                                              .shortInfoTextController.text,
                                          writer: 'Self',
                                          secret: !_model.secretValue!,
                                        )),
                                      ),
                                  );
                                  _model.updatePage(() {});
                  ...
                  Row(
                    ...
                    children: [
                      Switch.adaptive(
                        value: _model.secretValue!,
                        onChanged: (newValue) async {
                          safeSetState(() => _model.secretValue = newValue);
                        },
                          ...
                          child: Column(
                            ...
                            children: [
                              Align(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    if (_model.secretValue ?? false) {
                                      return Text(
                                        FFLocalizations.of(context).getText(
                                          '9p6561p8' /* AI will read this to help you */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
                                      ...
                                      return Text(
                                        FFLocalizations.of(context).getText(
                                          'k8fgepv5' /* AI will not read this */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'tf8rpyld' /* It will never be shared outsid... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelSmall
                                    .override(
