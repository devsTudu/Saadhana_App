...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: CreateHabitWidget.routePath,
          builder: (context, params) => CreateHabitWidget(),
        ),
        FFRoute(
          name: HabitViewWidget.routeName,
          path: HabitViewWidget.routePath,
          builder: (context, params) => HabitViewWidget(
        ...
        FFRoute(
          ...
          path: CommentReadWidget.routePath,
          builder: (context, params) => CommentReadWidget(
            indexHabit: params.getParam(
              'indexHabit',
              ParamType.int,
            ),
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Untitled_(920_x_1080_px).gif',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
