      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('MENU_PAGE_arrow_back_rounded_ICN_ON_TAP');
              ...
              children: [
                                  ...
                                  builder: (context) {
                                    if (currentUserEmail != '') {
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'MENU_PAGE_Text_u9iwyhmv_ON_TAP');
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'MENU_PAGE_Text_iqoy1xdc_ON_TAP');
                                          logFirebaseEvent('Text_auth');
                                          GoRouter.of(context)
                                              .prepareAuthEvent();
                                          await authManager.signOut();
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('MENU_PAGE_Container_krcgfoa8_ON_TAP');
                        logFirebaseEvent(
                        ...
                        logFirebaseEvent(
                            'DarkLightSwitchLarge_update_app_state');
                        FFAppState().isDarkMode =
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('MENU_PAGE_contentView_1_ON_TAP');
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      ...
                      context.pushNamed(
                        HabitSettingPageWidget.routeName,
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      ...
                      await launchURL(
                          'https://sites.google.com/view/privacy-policy-saadhana-app/home');
                    },
                    child: Container(
                      width: double.infinity,
                      height: 60.0,
