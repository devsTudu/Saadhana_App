...
class _Auth1WidgetState extends State<Auth1Widget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Auth1'});
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '8w0c9jrd' /* Let's get started by filling o... */,
                                                  ),
                                              ...
                                              Align(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'AUTH1_PAGE_FORGOT_PASSWORD_BTN_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Button_auth');
                                                      if (_model
                                                          .emailAddressTextController
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'kfkz7h69' /* Let's get started by filling o... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                              ...
                                              Align(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'AUTH1_PAGE_CREATE_ACCOUNT_BTN_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Button_auth');
                                                      GoRouter.of(context)
                                                          .prepareAuthEvent();
