...
class CreateHabitWidget extends StatefulWidget {
  ...
  static String routeName = 'CreateHabit';
  static String routePath = '/createHabit';
...
class _CreateHabitWidgetState extends State<CreateHabitWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'CreateHabit'});
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: FlutterFlowIconButton(
                                              ...
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'CREATE_HABIT_close_rounded_ICN_ON_TAP');
                                                logFirebaseEvent(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'CREATE_HABIT_PAGE_Row_jx2ukrl7_ON_TAP');
                                          logFirebaseEvent('Row_backend_call');
                                          _model.responseGeminiDescription =
                                              await GeminiCall.call(
                                            query:
                                                'You are an good mentor, you give practical and simple objectives to start working toward a goal or building habit, now please write a short description in 50 words about this habit, expressing what it is,its benifit, and how i will practice this habit regulary, habit name is ${_model.taskTextController.text}',
                                          );
                                          ...
                                          safeSetState(() {
                                            _model.descriptionTextController
                                              ...
                                              'I will try to take out time everyday for this',
                                            );
                                      ...
                                      Expanded(
                                        child: Align(
                                          ...
                                          child: FlutterFlowChoiceChips(
                                            options: HabitCategories.values
                                                .map((e) => e.name)
                                                .toList()
                                            ...
                                            child: Align(
                                              ...
                                              child: Switch.adaptive(
                                                ...
                                                onChanged: (newValue) async {
                                                  ...
                                                  if (newValue) {
                                                    logFirebaseEvent(
                                                        'CREATE_HABIT_Switch_ydigbrog_ON_TOGGLE_O');
                                                    logFirebaseEvent(
                                      ...
                                      if (_model.switchValue ?? true)
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'CREATE_HABIT_Container_86jhky8w_ON_TAP');
                                            logFirebaseEvent(
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('CREATE_HABIT_PAGE_submit_btn_ON_TAP');
                        logFirebaseEvent('submit_btn_update_app_state');
                        FFAppState().addToUserhabit(HabitStruct(
                        ...
                        logFirebaseEvent('submit_btn_navigate_to');
